...
def hotspot_residues(trajectory_pdb, binder_chain="B", atom_distance_cutoff=4.0):
    # Parse the PDB file to finc the hotspot residues (?) From BindCraft as well (https://github.com/martinpacesa/BindCraft)
...
#From BindCraft as well (https://github.com/martinpacesa/BindCraft)
